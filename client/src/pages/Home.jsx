    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
      ...
      <Container className="px-4 sm:px-6 lg:px-8">
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 pb-16">
          {/* Latest Posts */}
          <div className="bg-white/70 backdrop-blur-md rounded-2xl shadow-lg p-6 hover:shadow-2xl hover:scale-[1.02] md:hover:scale-[1.02] transition">
          ...
          {/* Upcoming Contests */}
          <div className="bg-white/70 backdrop-blur-md rounded-2xl shadow-lg p-4 sm:p-5 lg:p-6 hover:shadow-2xl hover:scale-[1.02] transition">
