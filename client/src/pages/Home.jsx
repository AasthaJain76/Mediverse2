...
function Home() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-50 to-indigo-50 px-4">
        <h1 className="text-base sm:text-xl font-semibold text-gray-600 animate-pulse text-center">
          Loading dashboard...
        </h1>
      </div>
    );
  ...
  if (error) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-50 to-indigo-50 px-4">
        <h1 className="text-base sm:text-xl font-semibold text-red-500 text-center">
          {error}
        </h1>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 overflow-x-hidden">
      ...
      <section className="text-center py-8 sm:py-12 md:py-20 px-4">
        <h2 className="mt-4 text-base sm:text-lg md:text-xl font-semibold bg-clip-text text-transparent 
      ...
      <Container className="px-4 sm:px-6 lg:px-8">
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 pb-16">
          
          {/* Latest Posts */}
          <div className="bg-white/70 backdrop-blur-md rounded-2xl shadow-lg p-4 sm:p-5 lg:p-6 hover:shadow-2xl md:hover:scale-[1.02] transition">
            ...
            {posts.length > 0 ? (
              posts.map((post) => {
                ...
                const snippet =
                  plainContent.split(" ").slice(0, 3).join(" ") +
                  (plainContent.split(" ").length > 3 ? "..." : "");
          ...
          {/* Upcoming Contests */}
          <div className="bg-white/70 backdrop-blur-md rounded-2xl shadow-lg p-4 sm:p-5 lg:p-6 hover:shadow-2xl md:hover:scale-[1.02] transition">
            <h2 className="flex items-center gap-2 text-lg sm:text-xl font-bold text-blue-700 mb-4">
